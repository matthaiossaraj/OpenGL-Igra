...
//			render3D();
	...
	private void renderModel() {
	    ...
	    GL11.glColor4f(col2_R, col2_G, col2_B, col_A);
	    GL11.glVertex3f(v1[0], v1[1], v1[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v2[0], v2[1], v2[2]);
	    GL11.glColor4f(col1_R, col1_G, col1_B, col_A);
	    GL11.glVertex3f(v2[0], v2[1], v2[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v3[0], v3[1], v3[2]);
	    GL11.glColor4f(col2_R, col2_G, col2_B, col_A);
	    GL11.glVertex3f(v3[0], v3[1], v3[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v4[0], v4[1], v4[2]);
	    GL11.glColor4f(col1_R, col1_G, col1_B, col_A);
	    GL11.glVertex3f(v4[0], v4[1], v4[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v5[0], v5[1], v5[2]);
	    GL11.glColor4f(col2_R, col2_G, col2_B, col_A);
	    GL11.glVertex3f(v5[0], v5[1], v5[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v6[0], v6[1], v6[2]); 		    
	    GL11.glColor4f(col1_R, col1_G, col1_B, col_A);
	    GL11.glVertex3f(v6[0], v6[1], v6[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v7[0], v7[1], v7[2]);
	    GL11.glColor4f(col2_R, col2_G, col2_B, col_A);
	    GL11.glVertex3f(v7[0], v7[1], v7[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v8[0], v8[1], v8[2]);
	    GL11.glColor4f(col1_R, col1_G, col1_B, col_A);
	    GL11.glVertex3f(v8[0], v8[1], v8[2]); GL11.glVertex3f(v9[0], v9[1], v9[2]); GL11.glVertex3f(v1[0], v1[1], v1[2]);
	    GL11.glEnd();
